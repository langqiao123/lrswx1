...
public class QRCode {
	...
	public static void main(String[] args) {
		...
		QRCode.encode("https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx812eea92b8bd7255&redirect_uri=http%3a%2f%2ftv.api.pptv.com%2ffirstSport%2fhome%3fversion%3d3&response_type=code&scope=snsapi_userinfo&state=STATE#wechat_redirect ", file,filePostfix, BarcodeFormat.QR_CODE, 500, 500, null);
		QRCode.decode(file);
	}
